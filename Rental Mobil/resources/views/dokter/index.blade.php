                        ...
                        <tbody>
                            @foreach ($data_dokter as $dokter)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('dokter/detail/' . $dokter->id) }}"><button
                                                class="btn btn-success">Detail</button></a>
                                        <a href="{{ url('dokter/edit/' . $dokter->id) }}"><button class="btn btn-warning">Edit</button></a>
                                        <a href="{{ url('dokter/delete/' . $dokter->id) }}">
                                            <button class="btn btn-danger"
                                                onclick="return confirm('Hapus nama dokter yang bernama {{ $dokter->nama }}')">Hapus</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
