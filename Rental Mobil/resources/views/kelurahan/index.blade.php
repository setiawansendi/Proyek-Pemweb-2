            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('kelurahan/detail/' . $kelurahan->id) }}"><button class="btn btn-success">Detail</button></a>
                    <a href="{{ url('kelurahan/edit/' . $kelurahan->id) }}"><button class="btn btn-warning">Edit</button></a> 
                    <a href="{{ url('kelurahan/delete/' . $kelurahan->id) }}"><button class="btn btn-danger" onclick="return confirm('Hapus nama kelurahan yang bernama {{ $kelurahan->id }}')">Hapus</button></a>
                </tr>
                @endforeach
              </tbody>
            </table>
