              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{ url('unit_kerja/delete/' . $unit_kerja->id) }}"><button class="btn btn-danger" onclick="return confirm('Hapus nama unit kerja yang bernama {{ $unit_kerja->id }}')">Hapus</button></a>
                @endforeach
              </tbody>
            </table>
          </div>
